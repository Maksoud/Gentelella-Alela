...
(function($) {
    $(document).ready(function($) {
        ...
        AddTableRow = function () 
        {
            ...
            /* (Quantidade X Valor Unitário) - Desconto + IPI */
            var vltotal = (Number(qtd) * Number(vlunity.value)) - Number(vldiscount.value) + Number(ipi.value);
            ...
            var row2 = $('<tr style="font-size: 11px;">'), list_vlunity, list_vldiscount, list_ipi, list_icms, list_vltotal;
            ...
            var line2 = row2.append(list_vlunity + list_vldiscount + list_icms + list_ipi + list_vltotal);
