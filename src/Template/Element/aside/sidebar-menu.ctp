...
<ul class="sidebar-menu tree" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu menu">
            ...
            <li><?= $this->Html->link('<i class="fa fa-exchange"></i> '.__('Transferências'), ['controller' => 'Pages', 'action' => 'modalContent'], ['class' => 'btn_modal', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Relatório - Transferências'), 'escape' => false]) ?></li>
